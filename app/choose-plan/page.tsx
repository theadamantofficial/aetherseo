...
const pageCopy = {
  en: {
    ...
    continueToPayment: "Continue to Razorpay",
    back: "Back",
  ...
  es: {
    ...
    continueToPayment: "Continuar a Razorpay",
    back: "Volver",
  ...
  fr: {
    ...
    continueToPayment: "Continuer vers Razorpay",
    back: "Retour",
  ...
  hi: {
    ...
    continueToPayment: "Razorpay continue karo",
    back: "Back",
