          ...
          {paidPlans.map((plan) => {
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <p className="site-accent-text text-xs uppercase tracking-[0.16em]">
                      {plan.badge}
                    </p>
                ...
                <div className="mt-7 flex-1 space-y-3">
                  {plan.features.map((feature) => (
                    <div
                      key={feature}
                      className="site-panel-soft rounded-[1.2rem] border px-4 py-3 text-sm"
                    >
                      {feature}
                    </div>
                  ))}
                ...
                <button
                  ...
                  className="site-button-primary mt-6 flex w-full items-center justify-center rounded-full px-5 py-3 text-sm font-semibold disabled:cursor-not-allowed disabled:opacity-70"
                >
