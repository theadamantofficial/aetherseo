        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr,0.95fr] lg:items-end">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="site-panel-soft rounded-[1.6rem] border px-5 py-5">
              <p className="site-accent-text text-xs uppercase tracking-[0.16em]">Content flow</p>
            ...
            <div className="site-panel-soft rounded-[1.6rem] border px-5 py-5">
              <p className="site-accent-text text-xs uppercase tracking-[0.16em]">Search layer</p>
